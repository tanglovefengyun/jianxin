...
function calculateTransformOrigin() {
  if (!dialogRef.value) return 'center'
      ...
      >
        ...
        >
          ...
          <div v-if="title || showClose || $slots.title" class="relative pr-4">
            ...
            <span v-if="showClose" class="absolute right-0 top-0 cursor-pointer btn-danger" @click="handleClose">
              <i i-carbon:close p-2.8 title="关闭" />
            </span>
          </div>
          <!-- 内容区 -->
          <slot />
